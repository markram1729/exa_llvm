...
@.str = private unnamed_addr constant [8 x i8] c"My algo\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_exa_ll.cpp, ptr null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_exa_ll.cpp() #0 section ".text.startup" {
...
!5 = !{!"clang version 19.0.0git (https://github.com/llvm/llvm-project 37eb9c9632fb5e82827d1a0559f2279e9a9f1969)"}
